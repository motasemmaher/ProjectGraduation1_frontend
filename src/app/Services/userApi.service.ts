...
export class UserApiService  {
  ...
  constructor(private http:HttpClient) {
    ...
    //   if (this.location.path() == '/auth/logout') {
    //     this.isLogin = false;
    //   } else {
    //   }
    // });
  ...
  getIslogin():Observable<any>{
    // this.auth.onTokenChange().pipe().subscribe((token) =>{
    //   console.log(token)
    //   if(token.isValid())
    //     this.isLogin = true
    //   else
  ...
  // changelogin():Observable<any>{
  //   this.isLogin =!this.isLogin
  //   return <any>this.isLogin
  // }
